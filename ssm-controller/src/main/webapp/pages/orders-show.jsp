				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							value="${orders.oid}" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${orders.product.pdateStr}"
								readonly="readonly">
						</div>
					</div>
...
--%><%--
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="10" value="${traveller.tname}"
									readonly="readonly"></td>
								<td><input type="text" size="10" value="${traveller.tsex}"
									readonly="readonly"></td>
								<td><input type="text" size="20"
									value="${traveller.tphoneNum}" readonly="readonly"></td>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${orders.member.mid}</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${orders.member.mname}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${orders.member.mphoneNum}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${orders.member.memail}</div>

				</div>
			</div>
			<!--联系人信息/--> <!--费用信息--> <%--<c:if test="${orders.ostratus==1}">
				<div class="panel panel-default">
